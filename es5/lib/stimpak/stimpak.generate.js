...
generate;var _incognito = require("incognito");var _incognito2 = _interopRequireDefault(_incognito);var _lodash = require("lodash.template");var _lodash2 = _interopRequireDefault(_lodash);var _lodash3 = require("lodash.templatesettings");var _lodash4 = _interopRequireDefault(_lodash3);var _glob = require("glob");var _glob2 = _interopRequireDefault(_glob);var _fsExtra = require("fs-extra");var _fsExtra2 = _interopRequireDefault(_fsExtra);var _vinyl = require("vinyl");var _vinyl2 = _interopRequireDefault(_vinyl);var _flowsync = require("flowsync");var _flowsync2 = _interopRequireDefault(_flowsync);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function generate(callback) {
	if (this.destination()) {
...
function renderSource(source, done) {var _this = this;
...
function renderFile(fileName, source, done) {var _this2 = this;
	...
	{(function () {
			...
			if (_fsExtra2.default.existsSync(newFile.path)) {(function () {
						...
						_flowsync2.default.mapSeries(mergeStrategies, function (mergeStrategy, mergeDone) {
							...
							if (newFile.path.match(mergePattern)) {
								...
								mergeFunction(_this2, newFile, oldFile, function (error, mergedFile) {
									if (error) {
										mergeDone(error);} else 
									{
										writeFile(mergedFile.path, mergedFile.contents, mergeDone);}});} else 
					...
					{
						writeFile(newFile.path, newFile.contents, done);}})();} else 
